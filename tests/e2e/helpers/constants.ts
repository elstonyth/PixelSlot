...
// Seeded operator (see scripts/qa-admin-e2e.mjs).
export const ADMIN_EMAIL =
  process.env.PW_ADMIN_EMAIL ?? 'qa-admin@pokenic.local';
export const ADMIN_PASSWORD = process.env.PW_ADMIN_PASSWORD ?? 'QaAdmin2026!';
