...
2. Parse `the target URL provided by the user` as one or more URLs. Normalize and validate each; if any are invalid, ask the user to correct them. Verify each is reachable.
