...
export const metadata: Metadata = {
  ...
  description: "How can we help? Our team typically responds within a few minutes.",
};

const VAULTS = [
  { name: "Vault 1", status: "Operational", note: "5–7 day processing", ok: true },
  { name: "Vault 2", status: "Operational", note: "5–7 day processing", ok: true },
  { name: "Vault 3", status: "Operational", note: "7–10 day processing", ok: true },
];
  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-fluid py-4">
      ...
      <section className="relative mb-8 overflow-hidden rounded-2xl border border-white/10 bg-neutral-950 px-6 py-14 text-center sm:py-16">
        ...
        <Reveal as="h1" className="relative font-heading text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
          How can we help?
        </Reveal>
        <Reveal as="p" delay={90} className="relative mx-auto mt-3 max-w-md text-sm leading-relaxed text-white/60 sm:text-base">
        ...
        <Reveal className="h-full">
          <div className="flex h-full flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            <div className="mb-1 flex items-center gap-2.5">
              ...
              <h2 className="font-heading text-lg font-bold tracking-tight text-white">Vault Status</h2>
            </div>
            <p className="mb-5 text-[13px] text-white/45">Current processing &amp; shipping times</p>
              ...
              {VAULTS.map((v) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="text-[13px] font-medium text-emerald-400">{v.status}</div>
        ...
        <Reveal delay={90} className="h-full">
          <div className="flex h-full flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-6">
            <div className="mb-1 flex items-center gap-2.5">
              ...
              <h2 className="font-heading text-lg font-bold tracking-tight text-white">FAQ</h2>
            </div>
            <p className="mb-5 text-[13px] text-white/45">Common questions answered</p>
            <ul className="flex flex-col gap-1.5">
              {FAQS.map((q) => (
                <li key={q}>
                  ...
                  >
                    {q}
                    <ChevronRight className="h-4 w-4 shrink-0 text-white/30 transition-transform group-hover:translate-x-0.5 group-hover:text-white/60" aria-hidden />
                  </a>
                </li>
              ))}
            </ul>
