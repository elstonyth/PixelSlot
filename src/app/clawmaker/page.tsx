  ...
  return (
    <div className="px-fluid flex min-h-[70vh] flex-col items-center justify-center py-16 text-center">
      <div className="relative flex h-20 w-20 items-center justify-center">
        <div className="absolute inset-0 rounded-full bg-amber-400/15 blur-2xl" aria-hidden />
      ...
      <h1 className="mt-6 text-2xl font-bold text-neutral-50">Access Restricted</h1>
      <p className="mt-2 text-sm text-neutral-400">Please login to view this page.</p>
    </div>
  );
}
