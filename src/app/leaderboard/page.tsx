...
// NOTE: This page needs client interactivity (a live countdown + tab state),
...
// per the build spec) — the global <SiteHeader/>/<SiteFooter/> from layout.tsx
// still wrap this page body.
...
// Top-3, mirroring the first three rows of <LeaderboardSection/>.
const PODIUM: PodiumPlayer[] = [
  { rank: 1, name: "FightingProdigy3098", points: "812,296,655", avatar: "/images/pfps/pfp-30.webp" },
  { rank: 2, name: "love", points: "428,287,429", avatar: "/images/pfps/pfp-81.webp" },
  { rank: 3, name: "PsychicGuardian5685", points: "139,937,985", avatar: "/images/pfps/pfp-71.webp" },
];
...
function Pagination() {
  ...
  return (
    <div className="mt-6 flex flex-col items-center justify-between gap-4 sm:flex-row">
      <p className="text-[13px] text-white/45">1-9 of 999</p>
    ...
    <div className="mx-auto w-full px-fluid py-4">
      ...
      {tab === "Prizes" ? (
        ...
        <>
          ...
          <LeaderboardSection key={tab} showHeading={false} />
          <Pagination />
        </>
      )}
    </div>
