...
const before = await p.evaluate(()=>getComputedStyle(document.querySelector("[data-tc]").firstElementChild).transform);
...
const after = await p.evaluate(()=>getComputedStyle(document.querySelector("[data-tc]").firstElementChild).transform);
console.log("before:", before);
console.log("after :", after);
console.log("RESULT:", before!==after && after!=="none" ? "PASS - card lifts on hover" : "FAIL");
await b.close();
