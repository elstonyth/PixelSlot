...
// ---- tweak these ----
const L = 30, T = 15, W = 28.5, H = 6.7;      // overlay box, % of image
...
const page = await browser.newPage({ viewport: { width: 1820, height: 760 }, deviceScaleFactor: 1.6 });
await page.goto("file:///" + resolve("docs/research/packdetail/overlay-test.html").replace(/\\/g, "/"), { waitUntil: "load" });
await page.waitForTimeout(1200);
// banner band across all three machines
await page.screenshot({ path: "docs/research/packdetail/overlay-test.png", clip: { x: 0, y: 16, width: 1760, height: 175 } });
await browser.close();
