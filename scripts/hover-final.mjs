...
const read = ()=>p.evaluate(()=>{const c=getComputedStyle(document.querySelector("[data-tc]").firstElementChild);return {translate:c.translate, scale:c.scale};});
...
console.log("RESULT:", changed ? "PASS - card lifts/scales on hover (translate/scale change)" : "FAIL");
await b.close();
